...
| cameraOffset     | array   | A list of four floating point numbers in the following order: x, y, z, angle in degrees. This affects the overhead stream camera and can be used to test camera misalignment.
